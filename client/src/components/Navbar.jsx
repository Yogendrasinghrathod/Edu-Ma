import { School, CreditCard, LogOut, Compass, BookOpen, UserCircle } from "lucide-react";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto h-full hidden md:flex items-center justify-between px-6">
        ...
        <div className="flex items-center space-x-6">
          <Link to="/courses" className="font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-2">
            <Compass size={18} />
            <span>Explore</span>
          </Link>
          <Link to="/myLearning" className="font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-2">
            <BookOpen size={18} />
        ...
        <div className="flex items-center gap-4">
          {user ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Avatar className="cursor-pointer border-2 border-blue-500 hover:border-blue-400 hover:shadow-md hover:shadow-blue-300/20 transition-all">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-blue-500 to-purple-500 text-white">ED</AvatarFallback>
                </Avatar>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="w-56 p-2 rounded-lg border border-gray-200 dark:border-gray-800">
                <DropdownMenuLabel className="font-bold text-blue-600 dark:text-blue-400">My Account</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
                  <DropdownMenuItem className="rounded-md hover:bg-blue-50 dark:hover:bg-blue-950/50 cursor-pointer p-2 my-1">
                    <BookOpen className="mr-2 h-4 w-4" />
                    <Link to="myLearning" className="flex-1">My Learning</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="rounded-md hover:bg-blue-50 dark:hover:bg-blue-950/50 cursor-pointer p-2 my-1">
                  ...
                  <DropdownMenuItem className="rounded-md hover:bg-blue-50 dark:hover:bg-blue-950/50 cursor-pointer p-2 my-1">
                    ...
                    <Link to="logout" className="flex-1" >Logout</Link>
                  </DropdownMenuItem>
                </DropdownMenuGroup>
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" className="rounded-full border-blue-500 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/50 px-6">
      ...
      <div className="md:hidden flex items-center justify-between px-6 h-full">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-extrabold text-xl">Edu-<span className="text-blue-600 dark:text-blue-400">Ma</span></h1>
        </div>
        <MobileNavbar />
      </div>
    </div>
      ...
      <SheetContent className="flex flex-col gap-4 border-l border-gray-200 dark:border-gray-800">
        <SheetHeader className="flex flex-col items-center justify-between mt-4 mb-2">
          <div className="flex items-center gap-2 mb-4">
            ...
            <SheetTitle className="text-2xl font-bold">Edu-<span className="text-blue-600 dark:text-blue-400">Ma</span></SheetTitle>
          </div>
          <div className="p-1 rounded-full bg-gray-100 dark:bg-gray-800">
            <DarkMode />
          </div>
        ...
        <nav className="flex flex-col space-y-1 w-full">
          <Link to="/courses" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors">
            <Compass size={20} className="text-blue-600 dark:text-blue-400" />
            <span className="font-medium">Explore Courses</span>
          </Link>
          <Link to="/myLearning" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors">
            <BookOpen size={20} className="text-blue-600 dark:text-blue-400" />
            <span className="font-medium">My Learning</span>
          </Link>
          <Link to="/profile" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors">
            <UserCircle size={20} className="text-blue-600 dark:text-blue-400" />
            <span className="font-medium">Edit Profile</span>
          </Link>
          <Link to="/logout" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/50 transition-colors">
