    ...
    <div className="flex-1 mx-10">
      <div className="mb-4">
        <h1 className="font-bold text-xl dark:text-gray-300">
          Let&apos;s add lecture ,add some basic course details for your new
          lectures
        </h1>
        {/* <p className="text-sm">
      ...
      <div className="grid gap-y-3">
        <div className="grid w-full max-w-sm items-center gap-1.5 ">
          <Label htmlFor="courseTitle" className="dark:text-white">
            Title
          </Label>
          <Input
            type="text"
            ...
            className="dark:text-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2 ">
          ...
          <Button
            ...
            className="dark:text-white dark:bg-blue-600  dark:hover:bg-blue-950"
          >
            {isLoading ? (
              <>
