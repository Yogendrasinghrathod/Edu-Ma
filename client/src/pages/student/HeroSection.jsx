  ...
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center bg-gradient-to-br from-[#2563EB] to-[#1E3A8A] dark:from-gray-950 dark:to-gray-900 px-4 text-center overflow-hidden pt-16">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
        ...
        >
          <path
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V0C0,0,10,11.59,214.34,120 Q402.13,115.65,321.39,56.44Z"
            fill="currentColor"
          ></path>
        </svg>
      </div>
